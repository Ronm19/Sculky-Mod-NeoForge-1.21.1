...
public class SculkHeraldAnimations {
    public static final AnimationDefinition IDLE = AnimationDefinition.Builder.withLength(1.0F).looping()
            ...
            .addAnimation("herald's staff", new AnimationChannel(AnimationChannel.Targets.ROTATION,
            ...
            .addAnimation("herald's staff", new AnimationChannel(AnimationChannel.Targets.POSITION,
                    new Keyframe(0.0F, KeyframeAnimations.posVec(0.0F, 11.25F, 2.5F), AnimationChannel.Interpolations.LINEAR),
                    new Keyframe(0.5F, KeyframeAnimations.posVec(0.0F, 10.95F, 2.5F), AnimationChannel.Interpolations.LINEAR),
                    new Keyframe(1.0F, KeyframeAnimations.posVec(0.0F, 11.25F, 2.5F), AnimationChannel.Interpolations.LINEAR)
            ))
            .build();
    ...
    public static final AnimationDefinition WALKING = AnimationDefinition.Builder.withLength(1.3333F).looping()
            ...
            .addAnimation("herald's staff", new AnimationChannel(AnimationChannel.Targets.POSITION,
                    new Keyframe(0.0F, KeyframeAnimations.posVec(0.0F, 7.4F, 6.1F), AnimationChannel.Interpolations.LINEAR),
                    new Keyframe(0.6667F, KeyframeAnimations.posVec(0.0F, 7.4F, 6.1F), AnimationChannel.Interpolations.LINEAR)
            ))
            .build();
}
