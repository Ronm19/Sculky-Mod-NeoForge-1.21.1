...
public class SculkWolfAlphaAnimations {

    public static final AnimationDefinition SCULK_WOLF_ALPHA_WALKING_ANIM = AnimationDefinition.Builder.withLength(1.0F).looping()
    ...
    public static final AnimationDefinition SCULK_WOLF_ALPHA_IDLE_ANIM = AnimationDefinition.Builder.withLength(1.0F).looping()
            .addAnimation("tail", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
