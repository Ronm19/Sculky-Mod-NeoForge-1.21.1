...
public class SculkSandsnareAnimations {
    public static final AnimationDefinition SCULK_SANDSNARE_WALKING = AnimationDefinition.Builder.withLength(1.0F).looping()
