...
public class SculkBatModel <T extends SculkBatEntity> extends HierarchicalModel<T> {
    ...
    public SculkBatModel(ModelPart root) {
    ...
    public void setupAnim( SculkBatEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
