...
public class SculkFoxModel<T extends SculkFoxEntity> extends AgeableListModel<T> {
    ...
    public SculkFoxModel(ModelPart root) {
    ...
    @Override
    public void setupAnim(SculkFoxEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
